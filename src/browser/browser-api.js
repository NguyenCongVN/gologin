/** These are three functions that update various properties of a browser profile
via the GoLogin API.
All of these functions make a PATCH request to the GoLogin API with the
appropriate endpoint and parameters. They all use requestretry to automatically
retry the request up to three times with a delay of 2 seconds between retries,
and a timeout of 10 seconds. If the request fails after all retries, they
return an object with an empty body property.*/
import requestretry from 'requestretry';

import { API_URL } from '../utils/common.js';

/**
* updateProfileResolution updates the resolution of a browser window associated
...
/**
 *
 * updateProfileUserAgent updates the User-Agent header sent by the browser
...
/**
*
* updateProfileProxy updates the proxy settings of the browser associated with
a given profile. It takes an object with the following properties:
